...
image = "/Users/jasonkuchtey/Desktop/asl_data/archive/asl_alphabet_test/asl_alphabet_test/I_test.jpg"
...
saved_model = "50x50isize5epochModel.keras"
...
if save:
    ...
    history = train_cnn(ourCNN, train_ds, val_ds, epochs, lr, save, model_name="50x50isize5epochModel.keras")
